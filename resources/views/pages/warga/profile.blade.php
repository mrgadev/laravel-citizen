    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 flex gap-1 sm:mb-0">
                ...
                <a href="#" class=" flex items-center gap-1 text-blue-600"><span class="material-symbols-rounded">person</span> Profile</a>
            </div>
        </div>

        <form action="{{route('dashboard-warga.profile.update')}}" method="POST" class="" enctype="multipart/form-data">
            @csrf
            @method('put')
