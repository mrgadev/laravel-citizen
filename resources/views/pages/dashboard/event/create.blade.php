    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 flex gap-1 sm:mb-0">
                ...
                <span class="material-symbols-rounded">chevron_right</span>
                <a href="{{route('paguyuban.index')}}" class=" flex items-center gap-1"><span class="material-symbols-rounded">diversity_1</span>Data Event</a>
                <span class="material-symbols-rounded">chevron_right</span>
                <a href="#" class=" flex items-center gap-1 text-blue-600"><span class="material-symbols-rounded">post_add</span> Buat Baru</a>
            </div>
        ...
        <div class="col-span-full xl:col-span-8 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
            ...
            <form action="{{route('event.store')}}" method="POST" enctype="multipart/form-data" class="p-3">
                @csrf
                @method('POST')
                ...
                <div class="grid md:grid-cols-3 gap-3 mb-5">
                    <div>
                        ...
                        <input id="nama" type="text" name="nama" required autofocus class="w-full rounded-md border-1 border-gray-400"/> 
                        @if($errors->has('nama'))
                    ...
                    <div>
                        ...
                        <input id="tgl_mulai" type="date" name="tgl_mulai" required autofocus class="w-full rounded-md border-1 border-gray-400"/> 
                    ...
                    <div>
                        ...
                        <input id="tgl_selesai" type="date" name="tgl_selesai" autofocus class="w-full rounded-md border-1 border-gray-400"/> 
                ...
                <div class="grid md:grid-cols-4 gap-3 mb-5">
                    <div>
                        ...
                        <input id="foto" type="file" name="foto" required autofocus class="w-full rounded-md border-1 border-gray-400 p-[6px]"/> 
                        @if($errors->has('foto'))
                    ...
                    <div>
                        ...
                        <input id="lokasi" type="text" name="lokasi" required autofocus class="w-full rounded-md border-1 border-gray-400"/> 
                    ...
                    <div>
                        ...
                        <input id="harga_tiket" type="number" name="harga_tiket" required autofocus class="w-full rounded-md border-1 border-gray-400"/> 
                ...
                <div>
                    ...
                    <textarea name="deskripsi" id="isi" class="w-full rounded-md outline-none border-1 border-gray-400"></textarea>
