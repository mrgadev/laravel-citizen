    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 flex gap-1 sm:mb-0">
                ...
                <a href="#" class=" flex items-center gap-1 text-blue-600"><span class="material-symbols-rounded">post</span> Event</a>
            </div>
        ...
        <div class="col-span-full xl:col-span-8 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
            <header class="p-4 border-b border-gray-100 dark:border-gray-700/60 flex flex-col gap-2 md:flex-row justify-between items-center">
                <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-100">Event</h2>
                <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                        ...
                        <form class="flex-col bg-white shadow-lg border-1 border-gray-600 p-3 rounded-lg">
                            ...
                            <div class="grid md:grid-cols-2 gap-3">
                                <div class="flex flex-col gap-1">
                                    ...
                                    <input type="text" name="nama" id="nama" class="border-1 border-gray-300 rounded">
                                </div>
                                <div class="flex flex-col gap-1">
                                    <label for="paguyuban_id">Penyelenggara</label>
                                    <select name="paguyuban_id" id="paguyuban_id" class="border-1 border-gray-300 rounded">
                                        <option value=""></option>
                            ...
                            <div class="grid md:grid-cols-2 gap-3">
                                <div class="flex flex-col gap-1">
                                    ...
                                    <input type="date" name="tgl_mulai" id="tgl_mulai" class="border-1 border-gray-300 rounded">
                                </div>
                                <div class="flex flex-col gap-1">
                                    <label for="lokasi">Lokasi</label>
                                    <select name="lokasi" id="lokasi" class="border-1 border-gray-300 rounded">
                                        <option value=""></option>
                    ...
                    <a href="{{route('event.create')}}" class="bg-blue-500 hover:bg-blue-700 transition-all text-white px-3 py-2 rounded flex items-center gap-1"><span class="material-symbols-rounded">domain_add</span>Tambah data</a>
            ...
            <div class="p-3">
                ...
                <div class="overflow-x-auto">
                    <table class=" w-full dark:text-gray-300" id="eventTable">
                        <!-- Table header -->
                        ...
                        <tbody class="text-sm font-medium divide-y divide-gray-100 dark:divide-gray-700/60">
                            ...
                            <tr class="py-4">
                                ...
                                <td class="p-2 ">
                                    <p>{{$event->harga_tiket}}</p>
                                </td>
                                <td class="p-2">
                                    <div class=" flex items-center gap-3">
                                        <a href="{{route('event.edit', $event->id)}}" class="flex items-center gap-1 border border-blue-500 text-blue-500 hover:bg-blue-500  hover:text-white transition-all px-3 py-1 rounded"><span class="material-symbols-rounded text-base">edit</span></a>
                                        <a href="{{route('event.show', $event->id)}}" class="flex items-center gap-1 bg-blue-500 text-white hover:bg-blue-700 transition-all px-3 py-1 rounded"><span class="material-symbols-rounded text-base">visibility</span></a>
