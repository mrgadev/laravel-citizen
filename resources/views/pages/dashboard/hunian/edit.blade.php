    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 flex gap-1 sm:mb-0">
                ...
                <span class="material-symbols-rounded">chevron_right</span>
                <a href="#" class=" flex items-center gap-1 text-blue-600"><span class="material-symbols-rounded">domain_add</span> Edit Data Hunian</a>
            </div>
        ...
        <div class="col-span-full xl:col-span-8 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
            <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60 flex flex-col gap-2 md:flex-row justify-between items-center">
                <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-100">Edit Data Hunian</h2>
                
            </header>
            {{-- <x-input-error></x-input-error> --}}
            <form action="{{route('hunian.update', $hunian->id)}}" method="POST" enctype="multipart/form-data" class="p-3">
                @csrf
                @method('PUT')
                <div >
                    <img src="{{Storage::url($hunian->foto)}}" alt="">
                    <x-label for="foto" value="{{ __('Foto Rumah') }}" />
                    <input class="w-full rounded outline-none border-1 border-gray-200 p-2" id="foto" type="file" name="foto" :value="old('foto')" autofocus />                
                    @if($errors->has('foto'))
                ...
                <div class="grid md:grid-cols-3 gap-5 my-3">
                    <div >
                        ...
                        <input class="w-full rounded outline-none border-1 border-gray-200" id="nama" type="text" name="nama" value="{{$hunian->nama}}" required autofocus />          
                        @if($errors->has('nama'))
                    ...
                    <div >
                        ...
                        <input class="w-full rounded outline-none border-1 border-gray-200" id="luas" type="number" name="luas" value="{{$hunian->luas}}" required autofocus />  
                        @if($errors->has('luas'))
                ...
                <div class="grid md:grid-cols-2 gap-3 mb-3">
                    <div >
                        ...
                        <input class="w-full rounded outline-none border-1 border-gray-200" id="km" type="number" name="km" value="{{$hunian->km}}" required autofocus />   
                        @if($errors->has('km'))
                    ...
                    <div >
                        ...
                        <input class="w-full rounded outline-none border-1 border-gray-200" id="kt" type="number" name="kt" value="{{$hunian->kt}}" required autofocus />       
                        @if($errors->has('kt'))
                ...
                <div class="grid md:grid-cols-2 gap-3">
                    <div>
                        ...
                        <textarea name="alamat" id="alamat" class="w-full rounded outline-none border-1 border-gray-300">{{$hunian->alamat}}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" class="w-full rounded outline-none border-1 border-gray-300">{{$hunian->deskripsi}}</textarea>
                    </div>
