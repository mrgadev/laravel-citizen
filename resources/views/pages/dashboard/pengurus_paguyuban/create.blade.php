    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 flex gap-1 sm:mb-0">
                ...
                <span class="material-symbols-rounded">chevron_right</span>
                <a href="#" class=" flex items-center gap-1 text-blue-600"><span class="material-symbols-rounded">group_add</span> Buat Baru</a>
            </div>
            ...
            <form action="{{route('paguyuban.store')}}" method="POST" enctype="multipart/form-data" class="p-3">
                ...
                <div class="grid md:grid-cols-3 gap-3 mb-5">
                    ...
                    <div >
                        ...
                        <x-input id="telepon" type="text" name="telepon" :value="old('telepon')" autofocus />                
                    </div>
                </div>
                <div >
