    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 flex gap-1 sm:mb-0">
                ...
                <a href="#" class=" flex items-center gap-1 text-blue-600"><span class="material-symbols-rounded">diversity_1</span> Data Paguyuban</a>
            </div>
                    ...
                    <table class=" w-full dark:text-gray-300">
                        ...
                        <thead class="text-xs uppercase text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-700 dark:bg-opacity-50 rounded-sm">
                            <tr>
                                ...
                                <th class="p-2">
                                    <div class="font-semibold text-center">Ketua</div>
                                </th>
                                <th class="p-2">
                            ...
                            <tr class="py-4">
                                ...
                                <td class="p-2">
                                    <div class="text-center flex items-center gap-3">
                                        <a href="{{route('paguyuban.edit', $paguyuban->id)}}" class="flex items-center gap-1 border border-blue-500 text-blue-500 hover:bg-blue-500  hover:text-white transition-all px-3 py-1 rounded"><span class="material-symbols-rounded text-base">edit</span> Edit</a>
                                        <a href="{{route('paguyuban.show', $paguyuban->id)}}" class="flex items-center gap-1 bg-blue-500 text-white hover:bg-blue-700 transition-all px-3 py-1 rounded"><span class="material-symbols-rounded text-base">visibility</span>Lihat</a>
