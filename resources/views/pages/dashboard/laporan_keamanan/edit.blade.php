    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 flex gap-1 sm:mb-0">
                ...
                <span class="material-symbols-rounded">chevron_right</span>
                <a href="#" class=" flex items-center gap-1 text-blue-600"><span class="material-symbols-rounded">post_edit</span> Edit Laporan</a>
            </div>
        ...
        <div class="col-span-full xl:col-span-8 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
            ...
            <form action="{{route('satpam.laporan.update', $laporanKeamanan->id)}}" method="POST" enctype="multipart/form-data" class="p-3">
                @csrf
                @method('PUT')
                <div class="grid md:grid-cols-2 gap-3 mb-5">
                    <div>
                        <x-label for="title" value="{{ __('Judul Laporan') }}" />
                        <input class="w-full rounded-lg border-1 border-gray-400" id="title" type="text" name="title" value="{{$laporanKeamanan->title}}" required autofocus /> 
                        @if($errors->has('title'))
                ...
                <div class="grid gap-3 mb-5">
                    <div>
                        ...
                        {{-- <input name="laporan" id="laporan" type="file" class="p-2 w-full rounded-md outline-none border-1 border-gray-400"> --}}
