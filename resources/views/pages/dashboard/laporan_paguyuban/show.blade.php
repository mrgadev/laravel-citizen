    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 flex gap-1 sm:mb-0">
                ...
                <a href="{{route('riwayat_hunian.index')}}" class=" flex items-center gap-1"><span class="material-symbols-rounded">diversity_2</span> Data Paguyuban</a>
                <span class="material-symbols-rounded">chevron_right</span>
                <a href="{{route('paguyuban.show', $laporanPaguyuban->paguyuban->id)}}" class=" flex items-center gap-1"><span class="material-symbols-rounded">diversity_2</span>{{$laporanPaguyuban->paguyuban->nama}}</a>
                <span class="material-symbols-rounded">chevron_right</span>
        ...
        <div class="px-5 py-4 col-span-full xl:col-span-8 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
            <header class="border-b border-gray-100 dark:border-gray-700/60 flex flex-col gap-2 md:flex-row justify-between items-center">
                ...
                <a href="{{route('laporan.paguyuban.export.pdf', $laporanPaguyuban->id)}}" class="text-white bg-red-500 transition-all hover:bg-red-700 px-3 py-2 rounded "><i class="bi bi-file-earmark-pdf"></i> Ekspor data</a> 
            </header>
