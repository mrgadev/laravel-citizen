    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 flex gap-1 sm:mb-0">
                ...
                <a href="{{route('laporan.paguyuban.index')}}" class=" flex items-center gap-1"><span class="material-symbols-rounded">post</span> Laporan Paguyuban</a>
                <span class="material-symbols-rounded">chevron_right</span>
        ...
        <div class="col-span-full xl:col-span-8 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
            ...
            <form action="{{route('laporan.paguyuban.save')}}" method="POST" enctype="multipart/form-data" class="p-3">
                @csrf
                @method('POST')
                <div class="mb-5 grid md:grid-cols-2 gap-3">
                    <div>
                        <x-label for="judul" value="{{ __('Judul Laporan') }}" />
                        <input id="judul" type="text" name="judul" :value="old('judul')" required autofocus class="w-full rounded-lg border-1 border-gray-400"/> 
                    </div>
                ...
                <div class="mb-5">
                    <div>
                        ...
                        <textarea name="laporan" id="laporanUmum" class="w-full rounded-md outline-none border-1 border-gray-400"></textarea>
                    </div>
                </div>
