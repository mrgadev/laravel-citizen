<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <a href="{{route('ipl.export.pdf', $iuranIpl->id)}}" class="px-3 py-2 bg-red-500 text-white transition-all hover:bg-red-700 rounded-lg"><i class="bi bi-file-earmark-pdf"></i> Ekspor ke PDF</a>
        </div>
